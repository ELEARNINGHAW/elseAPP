...
<h3 style="margin:10px; margin-bottom:0px; margin-top:0px; padding:10px; color: #FFF; background-color: #600000;">Erwerbungsvorschlag für: {$colData[$work.collection_id].title}
...
<tbody>
 ...
 <tr>
 <tr>
   <td style="vertical-align: top; font-weight: bold;">(Optional) Bemerkungen <br>f&uuml;r die Studenten:</td>
